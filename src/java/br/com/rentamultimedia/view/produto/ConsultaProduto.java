...
@WebServlet(name = "ConsultaProduto", urlPatterns = {"/ConsultaProduto.do"})
public class ConsultaProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Consulta Produto</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            if(pf!=null){
                ...
                out.println("window.location.href = \"consultarproduto.jsp\";");
                out.println("</script>");
            }
            out.println("</body>");
            out.println("</html>");
