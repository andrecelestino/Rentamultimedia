...
@WebServlet(name = "ConsultaExcluirProduto", urlPatterns = {"/ConsultaExcluirProduto.do"})
public class ConsultaExcluirProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Consulta Excluir Produto</title>");            
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet ConsultaExcluirProduto at " + request.getContextPath() + "</h1>");
            factory=new Factory();
            ...
            if(pf!=null){
                ...
                request.getRequestDispatcher("excluirproduto.jsp").forward(request, response);
            }else{
                out.println("<script>");
