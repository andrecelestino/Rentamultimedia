...
@WebServlet(name = "ConsultaAlterarFornecedor", urlPatterns = {"/ConsultaAlterarFornecedor.do"})
public class ConsultaAlterarFornecedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Consulta Alterar Fornecedor</title>");            
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet ConsultaAlterarFornecedor at " + request.getContextPath() + "</h1>");
            factory=new Factory();
